...
$(document).ready(function(){
	...
	$('area, #regions li').hover( //hover listener
		...
		function() { //if the user hovers over an <area> element or a <li> in <ul class="regions">...
			...
			$('#map').attr("src","/getting-in.com/sites/all/modules/buddy/images/map-"+ area +"-mo.gif");  //change the image of the <area> to the mouseover version
		...
		function() { //if the mouse leaves an <area> element or a <li> in <ul class="regions">...
			...
			$('#map').attr("src","/getting-in.com/sites/all/modules/buddy/images/map.gif"); //change the image of the <area> back to default
